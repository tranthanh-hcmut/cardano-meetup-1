...
import { txs, txsDelegations, txsMetadataCbor, txsPoolRetires, txsPoolUpdates, txsStakes, txsUtxos, txsWithdrawals, txsMirs, txsMetadata, txsRedeemers, txsRequiredSigners, txsCbor, txSubmit } from './endpoints/api/txs';
...
declare class BlockFrostAPI {
    ...
    txsRequiredSigners: typeof txsRequiredSigners;
    txsCbor: typeof txsCbor;
    txSubmit: typeof txSubmit;
    network: typeof network;
    networkEras: typeof networkEras;
